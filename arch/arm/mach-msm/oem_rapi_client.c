...
//--> [ds1_cp_oem_rapi_using]
// replaced
//#define OEM_RAPI_CLIENT_MAX_OUT_BUFF_SIZE 128
#define OEM_RAPI_CLIENT_MAX_OUT_BUFF_SIZE 512
//<-- [ds1_cp_oem_rapi_using]
...
//  xdr_send_uint32(xdr, &arg->output_length);        //lsi@ds2 : FEATURE_SKY_RPC_OEM_RAPI_NEW_INTERFACE is added, so adding this field also need.
