...
#if ((BOARD_VER >=EF31S_WS10) ||(BOARD_VER >=EF32K_WS10)) 					  
static unsigned int keypad_row_gpios_EF13[] = {34,33};
static unsigned int keypad_col_gpios_EF13[] = {41,40};

#define EF13_KEYMAP_INDEX(row, col) ((row)* \
				ARRAY_SIZE(keypad_col_gpios_EF13) + (col))

static const unsigned short keypad_keymap_EF13[ARRAY_SIZE(keypad_col_gpios_EF13) *
					  ARRAY_SIZE(keypad_row_gpios_EF13)] = {

	[EF13_KEYMAP_INDEX(0, 0)] = KEY_VOLUMEUP,
	[EF13_KEYMAP_INDEX(0, 1)] = KEY_VOLUMEDOWN,
	
	[EF13_KEYMAP_INDEX(1, 0)] = KEY_SEARCH,
	[EF13_KEYMAP_INDEX(1, 1)] = KEY_HOME,
};
#elif ((BOARD_VER >=EF31S_PT10) ||(BOARD_VER >=EF32K_PT10)) 
static unsigned int keypad_row_gpios_EF13[] = {34,33,32};
static unsigned int keypad_col_gpios_EF13[] = {41,40,36};
...
static const unsigned short keypad_keymap_EF13[ARRAY_SIZE(keypad_col_gpios_EF13) *
	...
	[EF13_KEYMAP_INDEX(0, 0)] = KEY_VOLUMEUP,
	[EF13_KEYMAP_INDEX(0, 1)] = KEY_VOLUMEDOWN,
	[EF13_KEYMAP_INDEX(0, 2)] = KEY_RESERVED,
	
	[EF13_KEYMAP_INDEX(1, 0)] = KEY_RESERVED,
	[EF13_KEYMAP_INDEX(1, 1)] = KEY_HOLD,
	[EF13_KEYMAP_INDEX(1, 2)] = KEY_RESERVED,

	[EF13_KEYMAP_INDEX(2, 0)] = KEY_RESERVED,
	[EF13_KEYMAP_INDEX(2, 1)] = KEY_RESERVED,
	[EF13_KEYMAP_INDEX(2, 2)] = KEY_HOME,
};
#endif


/* EF13 keypad platform device information */
static struct gpio_event_matrix_info EF13_keypad_matrix_info = {
	.info.func	= gpio_event_matrix_func,
	.keymap		= keypad_keymap_EF13,
	.output_gpios	= keypad_row_gpios_EF13,
	.input_gpios	= keypad_col_gpios_EF13,
	.noutputs	= ARRAY_SIZE(keypad_row_gpios_EF13),
	.ninputs	= ARRAY_SIZE(keypad_col_gpios_EF13),
...
static struct gpio_event_info *EF13_keypad_info[] = {
	&EF13_keypad_matrix_info.info,
};

static struct gpio_event_platform_data EF13_keypad_data = {
	.name		= "surf_keypad",
	.info		= EF13_keypad_info,
	.info_count	= ARRAY_SIZE(EF13_keypad_info)
};

struct platform_device keypad_device_EF13 = {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &EF13_keypad_data,
	},
};
