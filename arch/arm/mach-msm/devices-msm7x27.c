...
/// wjmin2010.08.17@DS2 Added to use msm serial hs lite
...
#if 1 /* EF31 - ginger break */
static struct msm_serial_hslite_platform_data msm_uart_dm2_lite_pdata = {
	.config_gpio	= 1,
	.uart_tx_gpio	= 108,
	.uart_rx_gpio	= 21,
};
...
/// wjmin2010.08.17@DS2 changed name to use msm serial hs lite
#ifdef CONFIG_SERIAL_MSM_HSL
  .name = "msm_serial_hsl",
#else
	.name = "msm_serial_hs",
	...
	.dev		= {
		...
		.platform_data = &msm_uart_dm2_lite_pdata,
		.coherent_dma_mask = DMA_BIT_MASK(32),
	},
};
...
static struct resource msm_tdmb_resources[] = {
  {
    .name   = "tdmb_dev",
    .start  = 0x8c000000,  //MSM7227 EBI2 CS[1] base addr.
    .end    = 0x8c000000 + PAGE_SIZE - 1,
    .flags  = IORESOURCE_MEM,
  },
};
...
#if defined(CONFIG_UART2DM_CONSOLE) || defined(CONFIG_SERIAL_MSM_HSL)
	CLK_PCOM("uartdm_clk",	UART2DM_CLK,	"msm_serial_hsl.1", OFF),
#else
