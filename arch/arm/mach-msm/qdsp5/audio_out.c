...
#ifdef CONFIG_SKY_SND_MAX8981 //CONFIG_SKY_SND_MAX97001 97001 -> 8981 amp test 101214
int test_audio_enable[6]={1,0,1,0,0,0};
int enable_audio_out_log=0;
...
#ifdef CONFIG_SKY_SND_MAX8981 //CONFIG_SKY_SND_MAX97001 97001 -> 8981 amp test 101214
       snd_extamp_api_SetDefaultVolume(snd_extamp_GetCurrentDevice(),0);
       snd_extamp_api_SetDevice(1, snd_extamp_GetCurrentDevice());
//       snd_extamp_api_SetDefaultVolume(snd_extamp_GetCurrentDevice(),1);	//110113 amp unmute delay QE fix
#endif//CONFIG_SKY_SND_MAX8981
...
#ifdef CONFIG_SKY_SND_MAX8981 //CONFIG_SKY_SND_MAX97001 97001 -> 8981 amp test 101214
            snd_extamp_api_SetDevice(0, snd_extamp_GetCurrentDevice());
#endif//CONFIG_SKY_SND_MAX8981	
	return 0;
}
