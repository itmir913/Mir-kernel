...
#ifdef FEATURE_SKY_BATT_ID_NO_CHECK_FLAG
	REQ_CMD_BATT_ID_DISABLE_TEST,
#endif
...
#ifdef FEATURE_SKY_SAVE_LOG_SDCARD		//sylee
...
#endif
//#endif
  REQ_CMD_LED_COLOR_TEST = 0x10006001,
...
// //jsmoon201000412@DS2 add
	REQ_CMD_LEDTEST_SET_LIGHT_BRIGHTNESS = 0x10010001,
	REQ_CMD_LEDTEST_GET_LIGHT_BRIGHTNESS,

// //jsmoon20100607@DS2 add
	REQ_CMD_CLEAR_LOG =0x10020001,
  REQ_CMD_GET_SKY_ERRORLOG,
  REQ_CMD_GET_SKY_ERRORLOG_SIZE,
  
	REQ_CMD_SET_TEST_REBOOT = 0x1000a002,
	REQ_CMD_GET_TEST_REBOOT = 0x1000a003,
	
/// wjmin20100610@DS2 for RAM DUMP using QPST Memory Debug App
	REQ_CMD_SYS_RAMDUMP_GET_RAMDUMP=0x10030001,
	REQ_CMD_SYS_RAMDUMP_SET_RAMDUMP,
	
	REQ_CMD_SDCARD_SET_DETECTION_COUNT = 0x1000b001,
  REQ_CMD_SDCARD_GET_DETECTION_COUNT = 0x1000b002,

	REQ_CMD_WLAN_ENABLE = 0x10050001,
	REQ_CMD_WLAN_DISABLE,
	REQ_CMD_WLAN_TX_ON,
	REQ_CMD_WLAN_TX_OFF,
	
	REQ_CMD_SYS_GPIO_SETTING = 0x10060001,
	REQ_CMD_SYS_GPIO_GET = 0x10060002,
