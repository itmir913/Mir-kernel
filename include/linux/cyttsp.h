...
#define FEATURE_TOUCH_KEY //ST_LIM_20110101 - TOUCH KEY 기능 추가.  
#define FEATURE_SKY_PROCESS_CMD_KEY //ST_LIM_20110103 - FACTORY KEY  
#define FEATURE_SKY_TOUCH_FOR_SLEEP
#define FEATURE_SKY_TOUCH_DELTA_DEBUG
#define FEATUR_FINGER_IDX //ST_LIM_20110223 - 터치 핑거 ID 오동작 하는 문제 수정.
 ...
 ******************************************************************************
 */
#define FEATURE_CYTTSP_FIRMWAREUPGRADE //ST_LIM_20110118 - Touch Firmware Upgrade 기능 추가.
#define FEATURE_CYTTSP_FIRMWAREUPGRADE_DELAY //ST_LIM_20110323 - User 모드 릴리즈시 타이밍 문제로 인해 간헐적으로 I2C 통신 동작 오류로 Delay 추가.
//#define FEATURE_CYTTSP_FIRMWAREUPGRADE_NORETRY //ST_LIM_20110413 - FW upgrade 1번만 진행되게 변경.
#define FEATURE_CYTTSP_HEARTBEAT //ST_LIM_20110111 - Cypress HeartBeat 기능 추가.
#define FEATURE_SKY_CTYYSP_FLUSH_WORK_SCHEDULED //JYKWON - WORK scheduled 일때 suspend 발생하면 touch 동작하지 않는 현상 수정.
#define FEATURE_SKY_CYTTSP_POWER_ON_OFF // resume - power on, suspend - power off
#define FEATURE_CYTTSP_FIRMWAREVERSION_CHECK // TESTMENU #8378522# SW VERSION -> TOUCH FIRMWARE VERSION
...
#define GET_KEY_TOUCHES(x)	((x) & 0xC0) //터치키 입력시 체크하는 마스크
#define GET_KEY_BACK(x)		((x) & 0x80) //터치 왼쪽키 입력시
#define GET_KEY_MENU(x)		((x) & 0x40) //터치 오른쪽키 입력시
#endif
...
#define CYTTPS_FIRMWARE_VER_ID		12
#endif
