...
/// wjmin20100927@DS2 Use SMEM
#ifdef CONFIG_EF31S_32K_BOARD
		new_log_buf = smem_alloc(SMEM_ID_VENDOR1, size);
#else
...
// added by jwcha100806@DS2
void printk_console_suspend_disable(uint32_t flag)
{
	if (flag)
		console_suspend_enabled = 0;
	else
...
EXPORT_SYMBOL(printk_console_suspend_disable);
