...
#ifdef FEATURE_67024 // 1 //[BIH] patch 67024
...
static uint8_t suspend_sys_sync_abort;
...
/* value should be less then half of input event wake lock timeout value+ * which is currently set to 5*HZ (see drivers/input/evdev.c)+ */
