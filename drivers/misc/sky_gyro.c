...
/* debug option */
/* -------------------------------------------------------------------- */
//#define SENSOR_SKY_GYRO_DBG_ENABLE
#ifdef SENSOR_SKY_GYRO_DBG_ENABLE
#define dbg(fmt, args...)   printk("[SKY_GYRO] " fmt, ##args)
#else
#define dbg(fmt, args...)
#endif
...
#define SENSOR_INPUTDEV_NAME	"gyroscope"
