...
//카메라 진입 불량의 원인을 찾지 못해 임시로 적용하는 방어코드 100907_PSJ //
...
#define MT9P111_CFG_WB_MAX_PARAMS 				16//15//12//10
...
#define MT9P111_CFG_REFLECT_MAX_PARAMS 			7
#endif
