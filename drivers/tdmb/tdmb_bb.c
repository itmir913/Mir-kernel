...
#if defined(FEATURE_QTDMB_USE_INC_T3700)
#define TDMB_BB_DRIVE_INIT(x) \
      TDMB_MSG_BB("TDMB BB ---> [T3700]"); \
      tdmb_bb_t3700_init(x)
#elif defined(FEATURE_QTDMB_USE_INC_T3900)
#define TDMB_BB_DRIVE_INIT(x)  \
...
#if 0 // android not used
static uint8 weak_area, outof_weak_area;
static boolean weak_flag = FALSE;
//fic module에서 autoscan timer 끈 다음에 fic intr이 안나오는 경우..;;;
boolean autoscan_excepton_control = FALSE;
#endif // 0
...
static void tdmb_baseband_set_antenna_path(int);
...
boolean tdmb_bb_func_tbl_init(void)
{
  ...
  tdmb_bb_function_table.tdmb_bb_set_antenna_path  = tdmb_baseband_set_antenna_path;
...
/*====================================================================
FUNCTION       tdmb_bb_set_antenna_path
DESCRIPTION 
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
void tdmb_bb_set_antenna_path(int ant_type)
{
  TDMB_MSG_BB("[%s]~!!![%d]\n", __func__, ant_type);

  tdmb_bb_function_table.tdmb_bb_set_antenna_path(ant_type);
}
...
/*====================================================================
FUNCTION       tdmb_basebane_set_antenna
DESCRIPTION
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
static void tdmb_baseband_set_antenna_path(int ant_type)
{
}
