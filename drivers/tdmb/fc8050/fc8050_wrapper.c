...
/*====================================================================
FUNCTION       fc8050_i2c_test
DESCRIPTION 
DEPENDENCIES
RETURN VALUE
SIDE EFFECTS
======================================================================*/
void fc8050_i2c_test(uint8 test_id)
{
  uint8 data, temp;
  uint16 wdata,i;
  unsigned int ldata;
...
uint8 fc8050_drv_init(void)
{
  ...
  fc8050_i2c_test(1); // byte
  fc8050_i2c_test(2); // word
  fc8050_i2c_test(3); // long
  fc8050_i2c_test(4); // tuner
#endif /*  FC8050_I2C_RW_TEST */
  if(res)
    return FALSE;
...
{ 
  ...
  {
    fc8050_control_fic(0, 0); // FIC OFF
  }
  else
  {
#ifdef FEATURE_QTDMB_MULTI_CHANNEL_ENABLE
    fc8050_control_fic(1, 0); // FIC ON
#else
    fc8050_control_fic(0, 0); // FIC OFF
#endif
  }
