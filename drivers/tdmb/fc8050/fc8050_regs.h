...
extern void msWait(unsigned long ms);


#ifdef FEATURE_QTDMB_EBI_IF
#define FC8050_USE_EBI2 
#endif /* FEATURE_QTDMB_EBI_CMD */

#ifdef FEATURE_QTDMB_TSIF_IF
#define FC8050_USE_TSIF
#define FC8050_USE_I2C
#endif /* FEATURE_QTDMB_I2C_CMD */

#define TDMB_MSG_FCI_BB(fmt, arg...) \
...
#define BBM_I2C_CR        0x0316
  ...
  // AAC
#define BBM_AAC_RS5_FAIL_CNTD   0x0320
#define BBM_AAC_RS5_COR_BB0     0x0322
#define BBM_AAC_RS5_FRAME_CNT   0x0326
#define BBM_AAC_RS5_FAIL_CNTR   0x0328
#define BBM_AAC_RS5_COR_BB1     0x032A
#define BBM_AAC_RS5_TIMER       0x032E
#define BBM_AAC_MD_GP0          0x0330
#define BBM_AAC_MD_BUF_CTRL     0x0338
#define BBM_AAC_MD_ERR          0x0339
#define BBM_AAC_MD_SID_FM       0x033A
#define BBM_AAC_MD_SID_RDS      0x033B
#define BBM_AAC_MD_RF_CTRL      0x033C
#define BBM_AAC_DBG_EPM         0x033D

  // DM & TSIF
#define BBM_DM_BB_HDR0        0x0350 //VT_BER_PERIOD
#define BBM_DM_BB_HDR1        0x0352 //VT_ERROR_SUM
#define BBM_DM_BB_HDR2        0x0354 //RS_BER_PERIOD + FAIL CNT
#define BBM_DM_BB_HDR3        0x0356 //RS_ERROR_SUM
#define BBM_DM_BB_HDR4        0x0358
#define BBM_DM_BB_HDR5        0x035A
#define BBM_DM_BB_HDR6        0x035C
#define BBM_DM_BB_HDR7        0x035E
#define BBM_DM_BB_HDR8        0x0360
#define BBM_DM_BB_HDR9        0x0362
#define BBM_DM_BB_HDR10       0x0364
#define BBM_DM_BB_HDR11       0x0366
#define BBM_DM_BB_HDR12       0x0368
#define BBM_DM_BB_HDR13       0x036A
#define BBM_DM_BB_HDR14       0x036C
#define BBM_DM_BB_HDR15       0x036E

#define BBM_DM_RF_HDR0        0x0370
#define BBM_DM_RF_HDR1        0x0372
#define BBM_DM_RF_HDR2        0x0374
#define BBM_DM_RF_HDR3        0x0376

#define BBM_TS_PAUSE          0x0378
#define BBM_DM_CTRL           0x0379
#define BBM_TS_SELECT         0x037A
#define BBM_DM_RF_DEVID       0x037B
#define BBM_DM_TIMER_SET      0x037C
#define BBM_DM_TIMER_GAP      0x037E
...
// BUFFER MANAGEMENT
//----------------------------------------------------
#ifdef FC8050_USE_EBI2
#define FC8050_VIDEO_BUF_SIZE 40 // INTR size (188*FC8050_VIDEO_BUF_SIZE)
#define FC8050_VIDEO_BUF_MAX  80 // temp MAX. value
#else
#if 1
#define FC8050_VIDEO_BUF_SIZE (TSIF_CHUNK_SIZE) // INTR size (188*FC8050_VIDEO_BUF_SIZE)
#define FC8050_VIDEO_BUF_MAX  (TSIF_CHUNK_SIZE * 2) // temp MAX. value
#else
#define FC8050_VIDEO_BUF_SIZE 32 // INTR size (188*FC8050_VIDEO_BUF_SIZE)
#define FC8050_VIDEO_BUF_MAX  64 // temp MAX. value
#endif
#endif
#define FC8050_VIDEO_BUF_NUM  (FC8050_VIDEO_BUF_MAX/FC8050_VIDEO_BUF_SIZE)
...
#define CH0_BUF_LENGTH      (188*FC8050_VIDEO_BUF_SIZE*FC8050_VIDEO_BUF_NUM)
#define CH0_BUF_END         (CH0_BUF_START + CH0_BUF_LENGTH -1)
#define CH0_BUF_THR         (CH0_BUF_LENGTH/FC8050_VIDEO_BUF_NUM-1)
