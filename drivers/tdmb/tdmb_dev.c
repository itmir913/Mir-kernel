...
{
#ifndef FEATURE_QTDMB_USE_RTV_MTV350 // 20101110 cys MTV350 TSIF에서 인터럽트 발생
  int irq;
...
#endif /* FEATURE_QTDMB_USE_RTV_MTV350 */
...
#else /* FEATURE_QTDMB_USE_FCI */ // INC, Raontech
...
static void tdmb_test_interrupt(void)
{
  ...
  if(first_int)
  {
    ...
    tdmb_bb_read_msc(ts_data.msc_buf);
  }

  first_int = TRUE;
#else /* FEATURE_QTDMB_TSIF_IF */
