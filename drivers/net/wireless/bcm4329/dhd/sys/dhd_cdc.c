...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	int ret;
	uint up = 0;
	uint roamvar = 1;	// 20110715_roam_patch
...
#ifdef CONFIG_BCM4329_ROAM_ENABLE /* 20110715_roam_patch */
        {
                /* set internal roaming roaming parameters */
#ifdef CONFIG_BCM4329_ROAM_ENABLE //kychoi 110428 KT Requirement
