...
#endif
#define FEATURE_FACTORY_CMD_VER_10_42 //ST_LIM_20110209 - 신규공정 CMD 구현.
...
typedef enum
{
...
#ifdef FEATURE_FACTORY_CMD_VER_10_42
	FACTORY_CHECK_CAL_FLAG_I =	0x1E, //공정 사양서 10.42에서 플래그 이름 변경. FACTORY_CAL_FLAG_I -> FACTORY_CHECK_CAL_FLAG_I
#else
	...
	FACTORY_SHORTCUT_DIAL_I         = 0xD8,   // [ds1_cp_factory_diag_protocol]
	FACTORY_WIFI_MAC_RD_I	        = 0xE0,	// WiFi Mac Read Command //DS2_DSHYUN_20100525_ADD
	FACTORY_WIFI_MAC_WR_I	        = 0xE1,	// WiFi Mac Write Command
	FACTORY_WIFI_AP_INFO_I			= 0xE8,  // Scan된 AP의 SSID 및 RSSI Level 확인
	FACTORY_WIFI_CONNECT_I			= 0xE9,  // 전달 받은 SSID 로 join
#ifdef FEATURE_FACTORY_CMD_VER_10_42
	FACTORY_ANDROID_SHUTDOWN_I		= 0xE6,
	FACTORY_SENSOR_CHECK_I			= 0xEB, //PS2 TEAM SHS : ADD SENSOR RESULT
	FACTORY_RX_AGC_VERIFY_I		= 0xEA,
	FACTORY_DO_NV_BACKUP_I		= 0xEC,
	FACTORY_SET_CAL_FLAG_I		= 0xED,
#endif 
	FACTORY_PATTERN_UNLOCK_I		= 0xE7,	// PATTERN 
...
#ifdef FEATURE_FACTORY_CMD_VER_10_42
	FACTORY_CHECK_CAL_FLAG_I, //공정 사양서 10.42에서 플래그 이름 변경. FACTORY_CAL_FLAG_I -> FACTORY_CHECK_CAL_FLAG_I
