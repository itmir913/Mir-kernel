...
#if defined(FEATURE_PANTECH_MDS_MTC)
static struct miscdevice pantech_uinput_misc = {
	.fops		= &uinput_fops,
	.minor		= UINPUT_MINOR + 1,
	.name		= "pantech_uinput",//UINPUT_NAME,
};
#endif
...
{
#if defined(FEATURE_PANTECH_MDS_MTC)
	misc_register(&pantech_uinput_misc);
#endif
#if defined(FEATURE_PANTECH_STABILITY)
...
#endif	
#if defined(FEATURE_PANTECH_MDS_MTC)
	misc_deregister(&pantech_uinput_misc);
#endif
}
